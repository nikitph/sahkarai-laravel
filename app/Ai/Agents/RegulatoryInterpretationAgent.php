...
Takeaways must contain 3-7 concrete items, and glossary entries should only define genuinely useful regulatory terms. Preserve dates and monetary values exactly in prose. Every structured due_date and effective_date must use YYYY-MM-DD, even when the source uses DD.MM.YYYY. A due_date must contain one date, never a range or surrounding text. This is educational information, not legal advice.
PROMPT;
    }
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'effective_date' => $schema->string()->description('One calendar date in YYYY-MM-DD format, or null.')->nullable()->required(),
