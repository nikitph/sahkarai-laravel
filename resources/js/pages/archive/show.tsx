                                    ...
                                    <div className="flex gap-1">
                                        {['en', 'hi', 'gu', 'mr'].map(
                                            (locale) => (
                                                ...
                                                >
                                                    <Link
                                                        href={`/archive/${document.id}?locale=${locale}`}
                                                        preserveScroll
                                                    >
                                                        {locale.toUpperCase()}
                                                    </Link>
                        ...
                        <Card className="rounded-2xl">
                            ...
                            <CardContent className="space-y-3">
                                <Button asChild className="w-full">
                                    <a
                                        href={`/archive/${document.id}/download`}
                                    >
